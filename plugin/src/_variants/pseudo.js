...
const taggedPseudoClassMatcher = (tag, parent, combinator) => {
  ...
  return {
    ...
    match(input) {
      ...
      if (label !== '') warnOnce('The labeled variant is experimental and may not follow semver.');
      return {
        matcher,
...
// TODO: look at if this should be supported for Lit
