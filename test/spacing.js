...
test('arbitrary padding with warp css var and default value works', async ({ uno }) => {
  const classes = [
    'p-[var(--w-spacing,_8px)]',
    'px-[var(--w-spacing,_8px)]',
    'py-[var(--w-spacing,_8px)]',
    'pt-[var(--w-spacing,_8px)]',
    'pb-[var(--w-spacing,_8px)]',
    'pl-[var(--w-spacing,_8px)]',
    'pr-[var(--w-spacing,_8px)]',
  ];
  const { css } = await uno.generate(classes);
  expect(css).toMatchSnapshot();
});
...
test('arbitrary margin with warp css var and default value works', async ({ uno }) => {
  const classes = [
    'm-[var(--w-spacing,_8px)]',
    'mx-[var(--w-spacing,_8px)]',
    'my-[var(--w-spacing,_8px)]',
    'mt-[var(--w-spacing,_8px)]',
    'mb-[var(--w-spacing,_8px)]',
    'ml-[var(--w-spacing,_8px)]',
    'mr-[var(--w-spacing,_8px)]',
  ];
  const { css } = await uno.generate(classes);
  expect(css).toMatchSnapshot();
});
