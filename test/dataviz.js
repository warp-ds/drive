...
test("it generates css based on semantic dataviz tokens with alpha channel", async ({
  uno,
}) => {
  const classes = [
...
test("it should not generate css with incorrect alpha channel values", async ({
  uno,
}) => {
  const antiClasses = [
    "dv-s-bg/900",
