...
test('it generates css based on semantic dataviz tokens', async ({ uno }) => {
  const classes = [
    'dv-s-svgborder-warning',
    'dv-s-svgline-warning',
    'dv-s-border-warning',
    ...
    'dv-s-svgfill-neutral',
    'dv-s-bg-neutral',
    'dv-s-bg-negative',
    'dv-s-bg-warning',
    'dv-s-bg-positive',
    'dv-s-bg-category6',
    'dv-s-svgiconstroke-category7',
    'dv-s-svgiconfill-category7',
    'dv-s-icon-category7',
    'dv-s-icon-category8',
    'dv-s-icon-negative',
    'dv-s-icon-neutral',
...
test('it generates css based on semantic dataviz tokens with alpha channel', async ({ uno }) => {
  const classes = [
    ...
    'dv-s-svgborder-negative/90',
    'dv-s-svgline-negative/90',
    'dv-s-bg-positive/100',
    'dv-s-svgfill-neutral/15',
    'dv-s-outline-category7/5',
    'dv-s-icon-category8/99',
    'dv-s-svgiconfill-negative/1',
    'dv-s-svgiconstroke-neutral/0',
    'dv-s-text-positive/4',
    'dv-s-svgtext-warning/25',
  ];
...
test('pseudo', async ({ uno }) => {
  const classes = [
    ...
    'focus:dv-s-svgiconfill-category8-focus',
    'focus:dv-s-svgiconstroke-negative-focus',
    ...
    'hover:dv-s-svgline-neutral-hover',
