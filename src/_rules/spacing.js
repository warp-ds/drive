...
export const padding = [
  ...
  [/^p-\[(.\d*)(rem|px)?]$/, ([, value, unit], context) => ({ padding: resolveArbitraryValues(value, unit, context) })],
  [/^p([xy])-\[(.\d*)(rem|px)?]$/, ([, direction, value, unit], context) => 
    directionMap[direction].map(i => [`padding${i}`, resolveArbitraryValues(value, unit, context)])
  ],
  [/^p([rltb])-\[(.\d*)(rem|px)?]$/, ([, direction, value, unit], context) => 
    directionMap[direction].map(i => [`padding${i}`, resolveArbitraryValues(value, unit, context)])
  ],
];
...
export const margin = [
  ...
  // matching arbitrary values
  [/^m-\[(.\d*)(rem|px)?]$/, ([, value, unit], context) => ({ margin: resolveArbitraryValues(value, unit, context) })],
  [/^m([xy])-\[(.\d*)(rem|px)?]$/, ([, direction, value, unit], context) => 
  directionMap[direction].map(i => [`margin${i}`, resolveArbitraryValues(value, unit, context)])],
  [/^m([rltb])-\[(.\d*)(rem|px)?]$/, ([, direction, value, unit], context) => 
  directionMap[direction].map(i => [`margin${i}`, resolveArbitraryValues(value, unit, context)])],
];
